...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/v1ak1DVZDf)
...
```sh
npx nx serve anime-list
```

To create a production bundle:

```sh
npx nx build anime-list
```

To see all available targets to run for a project, run:

```sh
npx nx show project anime-list
```
