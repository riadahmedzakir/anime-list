...
export const HentaiEpisodeList: { [key: string]: Array<IEpisodeList> } = {
    ...
    "Bible Black Only Version": [
        {
            Episode: "1",
            Title: "At the Faculty Room Toilet... / Secret Lesson / Events in the Locker Room",
            Aired: "Jul 25, 2005"
        },
        {
            Episode: "2",
            Title: "Virgin Hunting: Obscene Dance of the Devils / Secret Torture / That`s a Teacher...",
            Aired: "Apr 25, 2006"
        },
        {
            Episode: "2",
    ...
    "Bubble de House de Marumarumaru The Animation": [
        {
            Episode: "1",
            Title: "Episode 1",
            Aired: "Aug 30, 2024"
